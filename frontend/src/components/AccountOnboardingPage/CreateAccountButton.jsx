...
import CreateAccountIcon from '../../assets/create-account.svg';

function CreateAccountButton() {

    return (
        <div className="w-[400px] h-[500px] relative cursor-pointer group">
            ...
            <div className="w-[300px] h-[250px] absolute top-[125px] left-[50px] overflow-hidden">
                <img src={CreateAccountIcon} alt="Create Account" className="w-full h-full group-hover:brightness-0 group-hover:invert transition-all" />
            </div>
        </div>
    );
}
